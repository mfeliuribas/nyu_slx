...
Hi, everyone! Thank you so much for having me. It is an pleasure to be here with you today sharing one of my projects. I am MFR, but you can call me Txell, and I am a Ph.D. candidate at Rutgers University. I will present to you what was actually my qualifying paper, which is an exploratory study on the acquisition of perfective past time reference in Spanish among early Spanish-English bilinguals, or, as many researchers call them, Spanish heritage speakers. 


# Studying Variation and Perfectivity

Since the early 2000s, there has been an increasing interest in Hispanic variationist sociolinguistics in studying the use of the Spanish perfective past time paradigms. Most of these variationist studies have focused on the use of these forms by monolinguals from different Spanish-speaking regions, as perfectivity can be expressed using the preterit or PRET (*bailé*, 'I danced') and the present perfect or PPERF (*he bailado*, 'I have danced').

Although both forms are used to talk about a concluded situation in the past and express anteriority with regard to the moment of speech, they differ in meaning and in the way the past event is conceived. However, establishing a clear boundary between these forms is somewhat complex, as they represent variable structures in Spanish and overlap functionally within the same contexts. 

In broad terms, and according to normative use, the preterit is used to refer to a situation that started and concluded in the past. It entails completion and is not used to express actions in progress. For that, the imperfect (*yo bailaba*, 'I was dancing') is generally employed. 
In contrast, the present perfect indicates an event that, even though it started in the past, is still relevant, recent, or somehow related to the present, at least from the speaker's perspective. 

Despite these general tendencies in meaning, that have been extensively described in different prescriptivist and descriptivist grammars, the use of the perfective past paradigms is subject to dialectal variation. So, what I just told you is not 100% accurate, as we will see.

---
The variationist studies on MLs have identified several key linguistic and social factors that influence the use of preterit and the present perfect, and have revealed differences not only in the usage rates of these forms, but also in the factors that constrain their uses. 

For example, the preterit is considered the default form to express perfectivity in most of the Spanish varieties, but the present perfect is favored and more productively used in Peninsular Spanish. 
...
---
Crucially, these studies have demonstrated that these forms represent variable structures in Spanish that overlap functionally within the same context. This means that we can say, for example, *Esta mañana he ido al médico* ('I have gone to the doctor this morning') but also *Esta mañana fui al médico* ('I went to the doctor this morning') and the message that we are communicating is basically the same, and no one will probably ever think that what we are saying is agrammatical. 

Studying monolinguals was sort of a first step, which led to a second phase where L2 learners were the focus. The results from these studies on monolinguals have been compared to those of English L2 learners of Spanish studying abroad, and have suggested that the preterit vis-à-vis present perfect distinction can indeed be acquired by nonnative speakers, but the use of these paradigms depends on the input received. 

There are a couple of studies by Geeslin and colleagues with L2 learners studying in Mexico and Spain, that showed that over the course of the immersion program, the L2 learners started using the present perfect in a more native-like way, meaning that by the end of the stay their uses resembled those of the local community. Those staying in León exhibited a more Peninsular-like pattern (for instance, they increased their usage of the present perfect and were more likely to use this form in *today*-contexts, such as 'this morning' or 'today') while those staying in Mexico City showed a more Mexican-like pattern (for example, they reduce their uses of the present perfect and basically limited it to undetermined contexts).

So, we have a pretty good understanding of how Spanish monolinguals from different varieties and L2 learners of Spanish employ the forms to express perfectivity. To summarize it, quickly, the present perfect differs both quantitatively and qualitatively in European and Latin American varieties, providing evidence of a shift in the use of the present perfect to perfective use in temporally indeterminate contexts and hodiernal contexts in Peninsular Spanish, in a way that differs from the Spanish spoken in other places such as Peru, Mexico, and Argentina.

However, the constraints of use of the Spanish present perfect, in particular, in early Spanish-English bilinguals are less clear **BECAUSE** there is a lack of research on this phenomenon. To my knowledge, there are only two studies that have attempted to examine the acquisition of these forms by early bilinguals, but not without limitations. Markle LaMontagne is a case study of 2 brothers and in Corbett et al. they put in the same group heritage speakers born in the US with late bilinguals (so, people that arrive here after the age of 8). And, also, in both studies they only provide descriptive stats, so we cannot really understand the effects of the predictors, since we just get some impressions. 

From my point of view, this variability in the uses of the preterit vs the present perfect raises many questions about the acquisition of the perfectivity outside Spanish-speaking countries: How do Spanish-English bilinguals express perfectivity in Spanish? Do they use the present perfect at all? Or do they use the preterit as the default form, even employing it in contexts were most monolinguals would favor the present perfect?
...
### Participants
28 early Spanish-English bilinguals between the ages of 18 and 60 participated in this study. Most of them reported growing up in a Spanish-speaking household, starting learning Spanish when they were infants and English by the start of elementary school. 
...
---
### Materials
Participants completed three tasks on Qualtrics: a demographic and language background questionnaire, a Spanish proficiency test, and a contextualized preference task. [Explicar cada uno brevemente.]

The aim of the CPT was collecting data about the respondents' preference towards the preterit and the present perfect in a controlled experimental environment. 
...
---
In the lexical aspect I decided to follow the telic-atelic distinction instead of following Vendler's classification. If you are wondering why I did that, I suppose that I can give you a couple of reasons. First, sticking to the atelic-telic distinction makes the experimental design easier and, of course, the task shorter. Second, the previous studies that have used experimental methods to test the acquisition of the present perfect and the preterit have followed this same distinction, so I considered it would be more beneficial to do that as well, as comparisons could be more clearly made.  

---
Let's take a look at an example... [explain a bit]
...
I also performed comparisons, taking 2Spaniards as the reference level, to find varying patterns across groups or at least confirm that there was a difference in the estimates that I was getting. Although the estimates were different, I wanted to statistically check if there was really a difference between the groups.

Before moving on to the results, I think that is important at least to mention a couple of things about BDA. Bayesian analysis focuses on understanding the whole range of possibilities within our data and how uncertain we are about them, instead of trying to estimate the only line of best fit. And, to do that, we report the results from the posterior distribution of the model, which represents all the possible outcomes and their corresponding pr probabilities. So I will not report any *p* values or use words such as *significant*. Instead, I will report Beta estimates, which represent the most likely values for an effect, and HDIs, which provide a measure of uncertainty around the estimated value. In other words, I will talk about the probability of the preterit and the present perfect of being selected. And, again, this probability comes from the posterior distribution of the model.
...
And the PPERF is favored by 2Spaniards compared to the other groups.
...
So, taken together, the results indicate that early Spanish-English  bilinguals can indeed acquire the distinction between the past perfective time forms in Spanish. In addition, they show sensitivity to the constraints identified in previous studies with monolingual Spanish speakers, in the direction of effect established in previous work, suggesting that the variation in the selection of the preterit vs the present perfect is systematic. And this variation is akin to monolingual native speakers, especially for those participants with two Spanish-speaking parents. 
...
Despite this limitations, this study offers valuable insights into factors that affect the variable selection of the PRET vs PPERF; represents a (first) step that aims to contribute to our understanding of the acquisition of variable norms; shows the complexity of the usage of perfective past time paradigms by early Spanish-English bilinguals, which is governed by both linguistic and extralinguistic factors; and challenges heritage language acquisition theories, such as those by Montrul and Silva-Corvalán, that explain bilingual patterns through concepts like *incomplete acquisition*, *attrition*, and *overgeneralization* or *simplification*. 
