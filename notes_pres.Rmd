...
Hi, everyone! Thank you so much for having me. It is an honor to be here with you today sharing one of my projects. I am MFR and I am a Ph.D. candidate at Rutgers University. I will present to you what was actually my qualifying paper, which is an exploratory study on the acquisition of perfective past time reference in Spanish among early Spanish-English bilinguals. 


# Studying Variation and Perfectivity

Since the early 2000s, there has been an increasing interest in Hispanic variationist sociolinguistics in studying the use of the Spanish perfective past time paradigms. Most of these studies have focused on the use of these forms by monolinguals from different Spanish-speaking countries, as perfectivity can be expressed using the preterit or PRET (*bailé*, 'I danced') and the present perfect or PPERF (*he bailado*, 'I have danced').
...
Despite these general tendencies in meaning, that have been described in different grammars, the use of the perfective past tenses is subject to dialectal variation. 

---
These variationist studies on MLs have identified several key linguistic and social factors that influence the use of preterit and the present perfect, and have revealed differences not only in the usage rates of these forms, but also in the factors that constrain their uses. 
...
So, we have a pretty good understanding of how Spanish monolinguals from different varieties and L2 learners of Spanish employ the forms to express perfectivity. To summarize it, quickly, the present perfect differs both quantitatively and qualitatively in European and Latin American varieties, providing evidence of a shift in the use of the present perfect to perfective use in temporally indeterminate past contexts and hodiernal contexts in Peninsular Spanish, in a way that differs from the Spanish spoken in other places such as Peru, Mexico, and Argentina.

However, the constraints of use of the Spanish present perfect, in particular, in early Spanish-English bilinguals are less clear **BECAUSE** there is a lack of research on this phenomenon. To my knowledge, there are only two studies that have attempted to examine variation in the uses of these forms by early bilinguals, but not without limitations. Markle LaMontagne is a case study of 2 brothers and in Corbett et al. they put in the same group heritage speakers born in the US with late bilinguals (so, people that arrive here after the age of 8). And, also, in both studies they only provide descriptive stats, so we cannot really understand the effects of the predictors, since we just get some impressions. 
...
Before moving on to the results, I think that is important at least to mention a couple of things about BDA. Bayesian analysis focuses on understanding the whole range of possibilities within our data and how uncertain we are about them, instead of trying to estimate the only line of best fit. And, to do that, we report the results from the posterior distribution of the model, which represents all the possible outcomes and their corresponding pr obabilities. So I will not report any *p* values or use words such as *significant*. Instead, I will report Beta estimates, which are the most likely values for an effect, and HDIs, which provide a measure of uncertainty around the estimated value. In other words, I will talk about the probability of the preterit and the present perfect of being selected, and all the results I will report come from the posteriors of my model and the comparisons.
