...
---
These studies on MLs have identified several key linguistic and social factors that influence the use of preterit and the present perfect, and have revealed differences not only in the usage rates of these forms, but also in the factors that constrain their uses. 
...
So, we have a pretty good understanding of how Spanish monolinguals from different varieties and L2 learners of Spanish employ the forms to express perfectivity. To summarize it, quickly, the present perfect differs both quantitatively
and qualitatively in European and Latin American varieties, providing evidence of a
shift in the use of the present perfect to perfective use in temporally indeterminate
past contexts and hodiernal contexts in Peninsular Spanish, in a way that differs
from the Spanish spoken in other places such as Peru, Mexico, and Argentina.
