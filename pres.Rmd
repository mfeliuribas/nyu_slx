---
title: "The Acquisition of the Past Perfective Forms by Early Spanish-English Bilinguals"
subtitle: "NYU Sociolinguistics Lab"
...
+ PRET and PPERF:
  + Represent a concluded situation, express anteriority

  + Differ in meaning and in the conception of the past event

+ According to normative use (Alarcos Llorach, 1979; RAE & ASALE, 2011):
  + PRET: hesternal and prehodiernal situations ('yesterday', 'two days ago', 'last month')

  + PPERF: hodiernal or temporally vague situations ('this morning', 'recently', 'already')

---
<br>

+ .black[Key findings] in previous variationist studies: 
...
+ .black[Summary:] 
  + Pretty good understanding of how MLs and L2ers express perfectivity
  
  + PPERF differs quantitatively <u>and</u> qualitatively in European and Latin American varieties &rarr; Shift in the use of PPERF to perfective use in Peninsular Spanish (*aoristic drift*)

+ But... What about .black[early bilinguals] (i.e., *heritage speakers*)? <br> &rarr; .black[Scarce research], not without limitations (Corbett et al., 2020; Markle LaMontagne, 2011)
...
### Participants
+ .black[28 early Spanish-English bilinguals] (16 females)
...
---
### Materials
1. .black[Demographic and Language Questionnaire] 
...
3. .black[Contextualized Preference Task]
  ...
  + Manipulated variables (3 x 2 design): 
...
<tbody>
  <tr>
    <td class="tg-09u7">Temporal reference</td>
    <td class="tg-09u7">Prehodiernal</td>
    <th class="tg-oe15"></th>
  ...
  <tr>
    ...
    <td class="tg-oe15"></td>
    <th class="tg-oe15"></th>
    <td class="tg-09u7">'Yesterday I have watched this movie.'</td>
  </tr>
  <tr>
    <td class="tg-oe15"></td>
    <td class="tg-09u7">Hodiernal</td>
    <th class="tg-oe15"></th>
  ...
  <tr>
    ...
    <td class="tg-oe15"></td>
    <th class="tg-oe15"></th>
    <td class="tg-09u7">'Today I have watched this movie.'</td>
  </tr>
  <tr>
    <td class="tg-oe15"></td>
  ...
  <tr>
    ...
    <td class="tg-oe15"></td>
    <th class="tg-oe15"></th>
    <td class="tg-09u7">'I have already watched this movie.'</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-oe15"></td>
    <th class="tg-oe15"></th>
    <td class="tg-09u7">'Today I have drawn a lion.'</td>
  </tr>
  <tr>
    <td class="tg-09u7"></td>
  ...
  <tr>
    ...
    <td class="tg-oe15"></td>
    <th class="tg-oe15"></th>
    <td class="tg-09u7">'Today I have drawn.'</td>
  </tr>
</tbody>
</table>
...
.black[Sample Stimulus [hodiernal, telic]]
...
--
.black[About Bayesian Data Analysis...]
...
- No *p* values, no words such as *significant* &rarr; $\beta$ estimates/HDI, <span style="font-weight:bold; color:black;">Probability</span> of being chosen
...
+ PPERF favored in hodiernal and undetermined contexts by those participants with familial ties to Spain, but to varying degrees &rarr; Input? (Pascual y Cabo & Rothman, 2012; Rothman, 2007)

+ Early Spanish-English bilinguals can acquire the distinction between the past perfective time forms in Spanish
...
+ Limitations and future steps
    + Small sample size &rarr; Add more data to the model + a control group
    
    + No data triangulation (e.g., spontaneous production data)
    
    + Perform all pairwise comparisons
    
    + Examine the effect of other potential extralinguistic variables (Putnam & Sánchez, 2013)

+ Despite these limitations, this study...

  + offers valuable insights into factors affecting the variable selection of the PRET vs PPERF
  
  + represents a step that aims to contribute to our understanding of the acquisition of variable norms in Spanish heritage speakers
  
  + shows the complexity of the usage of perfective past time paradigms by early Spanish-English bilinguals
  
  + challenges heritage language acquisition theories that explain bilingual patterns through concepts like *incomplete acquisition*, *attrition*, *overgeneralization* (Markle LaMontagne, 2011; Montrul, 2002; Silva-Corvalán, 2014;
Silva-Corvalán & Enrique-Arias, 2017)
...
<font size="3.90">  
<p>Alarcos Llorach, E. (1979). <i>Gramática de la Lengua Española</i>. Espasa.</p>
...
<p>Montrul, S. (2002). Incomplete acquisition and attrition of spanish tense/aspect
distinctions in adult bilinguals. <i>Bilingualism: Language and Cognition, 5</i>(1), 39–
68.</p>

<p>Montrul, S. (2012). <i>DELE Proficiency Test</i>.</p> 

<p>Pascual y Cabo, D., & Rothman, J. (2012). The (Il)Logical Problem of Heritage Speaker Bilingualism and Incomplete Acquisition. <i>Applied Linguistics, 33</i>(4), 450-455.</p>
...
<p>Prada Pérez, A. D., Gómez Soler, I., & Feroce, N. (2021). Variable Future-Time Expression in Spanish: A Comparison between Heritage and Second Language Learners. <i>Linguistic Approaches to Bilingualism, 3</i>(4), 478–508.</p>

<p>Putnam, M., & Sánchez, L. (2013). What's so incomplete about incomplete acquisition? A prolegomenon to modeling heritage language grammars. <i>Languages, 6</i>(4), 1–28.</p>
...
<font size="3.90">  
<p>Real Academia Española and Asociación de Academias de la Lengua Española. (2011). <i>Nueva Gramática Básica de la Lengua Española (7th ed)</i>. Asociación de Academias de la Lengua Española.</p>
...
<p>Rothman, J. (2007). Heritage speaker competence differences, language change, and input type: Inflected infinitives in Heritage Brazilian Portuguese. <i>International Journal of Bilingualism, 11</i>(4) (pp. 359–389).</p>
...
<p>Silva-Corvalán, C. (Ed.). (2014). <i>Bilingual Language Acquisition: Spanish and English in the First Six Years</i>. Cambridge University Press.</p>

<p>Silva-Corvalán, C., & Enrique-Arias, A. (2017). <i>Sociolingüística y pragmática del español</i> (2nd ed.). Georgetown University Press.</p>
